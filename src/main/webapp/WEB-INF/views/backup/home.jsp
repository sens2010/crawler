...
<html>
  ...
  <body >
				...
				<div>
					...
					<div
						...
						<img height="138" src="resources/images/index_toppic.gif"
							width="318"
							style="background-image: url(resources/images/01.gif); border: 0px; margin: 0px;">
					</div>
					<div
	...
	<div id="main" style="display:table;width:100%">
		...
		<div id="main_center" style="display:table-cell;cellpadding:0;cellspacing:0;background-color:#289cbf">
			<div style="background-image: url(resources/images/index_centerbg.gif); height: 9px;width:100%;margin:0;top:-51px;bottom:0;left:0;right:0;position:relative">       
            </div>
		</div>
